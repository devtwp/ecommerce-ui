...
export class ListadoHamburguesasComponent{
  productosJson = [
    ...
    { nombre: 'Hamburguesa con nombre largo test', precio: 12.99, imagen: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqIvY_EddgWVLKNZD3S-xTjijRkfogKFxFkA&s', descripcion: 'Descripcion larga para test Descripcion larga para test Descripcion larga para testDescripcion larga para testDescripcion larga para testDescripcion larga para testDescripcion larga ' },
